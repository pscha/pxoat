...
layout layouts[] = {
	...
	.spot2_height_pct = 61 }, // primary monitor66//{ .spot_start = SMART, .spot1_align = RIGHT, .spot1_width_pct = 60, .spot2_height_pct = 66 }, // secondary monitor, etc...
};
...
binding keys[] = {
	...
	{ .mod = Mod4Mask, .key = XK_n, .act = action_maximize_horz },
